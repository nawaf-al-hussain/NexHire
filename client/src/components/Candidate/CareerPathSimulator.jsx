...
const CareerPathSimulator = ({ onClose }) => {
    ...
    return (
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-black/50 backdrop-blur-sm">
            <div className="w-full max-w-4xl max-h-[90vh] overflow-y-auto glass-card rounded-[2.5rem] p-8 animate-in zoom-in duration-300">
                {/* Header - Design System: Header Card Pattern */}
                <div className="glass-card rounded-[3rem] p-8 bg-indigo-500/5 border border-indigo-500/20 mb-8">
                    <div className="flex items-center justify-between">
                        <div className="flex items-center gap-4">
                            ...
                            <div>
                                <h2 className="text-xl font-black uppercase tracking-tight">Career Path Simulator</h2>
